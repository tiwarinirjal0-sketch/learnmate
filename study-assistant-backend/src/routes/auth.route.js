...
import { register, login, getUser, updateUser, Chat, FlashCard,QuizGenerator, Summarize, CreateNewChat, ReceiveChats, AddMessageToChat, SpecificChat } from '../controllers/auth.controller.js';
...
router.get("/specificCHat/:id", auth, SpecificChat)
